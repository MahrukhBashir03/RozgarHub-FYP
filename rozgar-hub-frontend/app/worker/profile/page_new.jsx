...
export default function WorkerProfile() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 pt-20 pb-10 px-4">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 pt-20 pb-10 px-4">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            {profile.category && (
              <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                <p className="text-gray-600 text-sm mb-1">My Specialty</p>
                <p className="text-2xl font-bold text-green-600">{profile.category}</p>
              </div>
            )}
            ...
            {profile.experience && (
              <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-orange-500">
                ...
                <p className="text-2xl font-bold text-orange-600">{profile.experience} years</p>
              </div>
            )}
          </div>
        )}
        ...
        {profile && (
          <ProfileProgressTracker profile={profile} userRole="worker" />
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
          ...
          >
            ...
            <p className="text-sm text-gray-600">View job requests</p>
          </a>
          ...
          >
            <p className="text-2xl">🔍</p>
            <h3 className="font-bold text-gray-900 mt-2">Browse Jobs</h3>
          ...
          >
            ...
            <p className="text-sm text-gray-600">Chat with employers</p>
          </a>
        </div>
      </div>
    </div>
